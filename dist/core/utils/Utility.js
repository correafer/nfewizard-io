...
import NFeServicosUrl from '../config/NFeServicosUrl.json' assert { type: "json" };
import soapMethod from '../config/soapMethod.json' assert { type: "json" };
