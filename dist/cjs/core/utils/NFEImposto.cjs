...
exports.mountICMS = exports.mountPIS = exports.mountCOFINS = void 0;
...
exports.mountCOFINS = mountCOFINS;
const mountPIS = (pis) => {
    const { CST } = pis;
    const cst_pis = CST;
...
exports.mountPIS = mountPIS;
const mountICMS = (icms) => {
