...
class XmlBuilder {
    ...
    assinarXML(xml, tagAssinar) {
        ...
        const signedXmlObj = new xml_crypto_1.SignedXml({
     ...
     */
    buildSoapEnvelope(xml, soapMethod, soapVersion = "soap12", rootTagObj = null) {
