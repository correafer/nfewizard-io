...
class NFCEAutorizacaoService extends BaseNFe_js_1.default {
    ...
    async trataRetorno(xmlRetorno, indSinc, responseInJson) {
        try {
            ...
            const nfeRetornoAutService = new NFCERetornoAutorizacaoService_js_1.default(this.environment, this.utility, this.xmlBuilder, this.axios, this.saveFiles, this.gerarConsulta);
            const nfeRetornoAut = new NFCERetornoAutorizacao_js_1.default(nfeRetornoAutService);
    ...
    gerarXmlNFCEAutorizacao(data) {
        const createXML = (NFe) => {
            ...
            if (![4, 9].includes(NFe.infNFe.ide.tpEmis)) {
                qrCode = (0, NFCEQRCode_js_1.generateQRCodeURLOnline)(chaveAcesso, '2', NFe.infNFe.ide.tpAmb, Number(idCSC), String(tokenCSC), this.utility);
            }
            ...
            if ([4, 9].includes(NFe.infNFe.ide.tpEmis)) {
                ...
                qrCode = (0, NFCEQRCode_js_1.generateQRCodeURLOffline)(chaveAcesso, '2', tpAmb, diaEmissao, valNF, digestValue, Number(idCSC), String(tokenCSC), this.utility);
                xml2js_1.default.parseString(xmlAssinado, (err, result) => {
                    if (err) {
...
exports.default = NFCEAutorizacaoService;
